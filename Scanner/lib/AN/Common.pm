...
sub get_string
{
	...
	if (not exists $conf->{string}{lang}{$language}{key}{$key}{content})
	{
	    ...
	    hard_die($conf, $THIS_FILE, __LINE__, 6, "The 'string' generated by common.lib's 'get_string()' function is undefined.<br />This passed string key: '$key' for the language: '$say_language' may not exist in any of the XML files: ($xml_files).\n");
	}
