...
--
-- Name: snmp_apc_pdu; Type: TABLE; Schema: public; Owner: alteeve; Tablespace: 
--
...
ALTER TABLE public.snmp_apc_pdu OWNER TO alteeve;

--
-- Name: snmp_apc_pdu_id_seq; Type: SEQUENCE; Schema: public; Owner: alteeve
--
...
ALTER TABLE public.snmp_apc_pdu_id_seq OWNER TO alteeve;

--
-- Name: snmp_apc_pdu_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: alteeve
--
...
--
-- Name: snmp_apc_pdu_pkey; Type: CONSTRAINT; Schema: public; Owner: alteeve; Tablespace: 
--
...
--
-- Name: snmp_apc_pdu_node_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: alteeve
--
...
ALTER TABLE history.snmp_apc_pdu OWNER TO alteeve;
...
ALTER FUNCTION history_snmp_apc_pdu() OWNER TO alteeve;
