...
# Installing from USB, so 'cdrom' is not helpful
#cdrom
...
echo "Copying Dashboard tools into /sbin/striker/"
...
[striker02-centos6]
name=Striker 02 CentOS 6.6 + Custom Repository
...
### NOTE: On ASUS EeeBox machines, the USB drives comes up as 'sdb' normally. 
