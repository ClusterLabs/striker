...
curl http://10.20.4.2/centos6/x86_64/files/Tools/fence/fence_raritan_snmp > /usr/sbin/fence_raritan_snmp
...
curl http://10.20.4.2/centos6/x86_64/img/Striker/striker-master/tools/list-ips > /root/list-ips
...
curl http://10.20.4.2/centos6/x86_64/files/striker-tools.tar > /sbin/striker/striker-tools.tar
