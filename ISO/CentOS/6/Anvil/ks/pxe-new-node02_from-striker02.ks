...
url --url=http://10.20.4.2/centos6/x86_64/img/
...
network --device eth0 --bootproto dhcp --onboot yes --hostname new-node02.alteeve.com
...
mkdir /sbin/striker
curl http://10.20.4.2/centos6/x86_64/img/Striker/striker-master/tools/list-ips > /sbin/striker/list-ips
...
curl http://10.20.4.2/centos6/x86_64/img/Tools/fence/fence_raritan_snmp > /usr/sbin/fence_raritan_snmp
...
curl http://10.20.4.2/centos6/x86_64/img/Striker/striker-master/tools/anvil-map-network > /sbin/striker/anvil-map-network
...
curl http://10.20.4.2/centos6/x86_64/img/Tools/vm.sh > /root/vm.sh
