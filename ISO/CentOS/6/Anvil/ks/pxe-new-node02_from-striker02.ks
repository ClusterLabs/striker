...
url --url=http://10.20.4.2/c6/x86_64/img/
...
mkdir /sbin/striker
curl http://10.20.4.2/c6/x86_64/img/Striker/striker-master/tools/list-ips > /sbin/striker/list-ips
...
curl http://10.20.4.2/c6/x86_64/img/Tools/fence/fence_raritan_snmp > /usr/sbin/fence_raritan_snmp
...
curl http://10.20.4.2/c6/x86_64/img/Striker/striker-master/tools/anvil-map-network > /sbin/striker/anvil-map-network
