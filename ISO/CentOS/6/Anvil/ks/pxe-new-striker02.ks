...
wget http://10.20.4.1/centos6/x86_64/iso/Anvil_m2_CentOS-6.8_alpha.iso -O /mnt/sysimage/var/www/html/centos6/x86_64/iso/Anvil_m2_CentOS-6.8_alpha.iso
...
cp /mnt/source/ks/pxe-new-node01_from-striker02.ks /mnt/sysimage/var/www/html/centos6/x86_64/ks/pxe-new-node01.ks
cp /mnt/source/ks/pxe-new-node02_from-striker02.ks /mnt/sysimage/var/www/html/centos6/x86_64/ks/pxe-new-node02.ks
...
[striker02-centos6]
name=Striker 02 centos6 v6.8 + Custom Repository
...
LABEL pxe-new-node01
	...
	IPAPPEND 2
	APPEND initrd=boot/centos6/x86_64/initrd.img ks=http://10.20.4.2/centos6/x86_64/ks/pxe-new-node01.ks ksdevice=bootif
...
LABEL pxe-new-node02
	...
	KERNEL boot/centos6/x86_64/vmlinuz
	IPAPPEND 2
	APPEND initrd=boot/centos6/x86_64/initrd.img ks=http://10.20.4.2/centos6/x86_64/ks/pxe-new-node02.ks ksdevice=bootif
...
LABEL pxe-new-striker01
	...
	KERNEL boot/centos6/x86_64/vmlinuz
	IPAPPEND 2
	APPEND initrd=boot/centos6/x86_64/initrd.img ks=http://10.20.4.2/centos6/x86_64/ks/pxe-new-striker01.ks ksdevice=bootif
...
LABEL pxe-new-striker02
	...
	KERNEL boot/centos6/x86_64/vmlinuz
	IPAPPEND 2
	APPEND initrd=boot/centos6/x86_64/initrd.img ks=http://10.20.4.2/centos6/x86_64/ks/pxe-new-striker02.ks ksdevice=bootif
