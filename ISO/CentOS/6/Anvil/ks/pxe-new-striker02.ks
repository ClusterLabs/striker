...
wget http://10.20.4.1/c6/x86_64/iso/Anvil_m2_RHEL-6.7_alpha.iso -O /mnt/sysimage/var/www/html/c6/x86_64/iso/Anvil_m2_RHEL-6.7_alpha.iso

# Make sure our source is mounted.
mount -o loop /mnt/sysimage/var/www/html/c6/x86_64/iso/Anvil_m2_RHEL-6.7_alpha.iso /mnt/source/
...
cp /mnt/source/ks/pxe-new-node01_from-striker02.ks /mnt/sysimage/var/www/html/c6/x86_64/ks/pxe-new-node01.ks
cp /mnt/source/ks/pxe-new-node02_from-striker02.ks /mnt/sysimage/var/www/html/c6/x86_64/ks/pxe-new-node02.ks
...
[striker02-c6]
name=Striker 02 c6 v6.7 + Custom Repository
...
LABEL pxe-new-node01
	...
	IPAPPEND 2
	APPEND initrd=boot/c6/x86_64/initrd.img ks=http://10.20.4.2/c6/x86_64/ks/pxe-new-node01.ks ksdevice=bootif
...
LABEL pxe-new-node02
	...
	KERNEL boot/c6/x86_64/vmlinuz
	IPAPPEND 2
	APPEND initrd=boot/c6/x86_64/initrd.img ks=http://10.20.4.2/c6/x86_64/ks/pxe-new-node02.ks ksdevice=bootif
...
LABEL pxe-new-striker01
	...
	KERNEL boot/c6/x86_64/vmlinuz
	IPAPPEND 2
	APPEND initrd=boot/c6/x86_64/initrd.img ks=http://10.20.4.2/c6/x86_64/ks/pxe-new-striker01.ks ksdevice=bootif
...
LABEL pxe-new-striker02
	...
	KERNEL boot/c6/x86_64/vmlinuz
	IPAPPEND 2
	APPEND initrd=boot/c6/x86_64/initrd.img ks=http://10.20.4.2/c6/x86_64/ks/pxe-new-striker02.ks ksdevice=bootif
