...
wget http://10.20.4.1/centos6/x86_64/iso/Anvil_m2_CentOS-6.7_alpha.iso -O /mnt/sysimage/var/www/html/centos6/x86_64/iso/Anvil_m2_CentOS-6.7_alpha.iso
...
[striker02-centos6]
name=Striker 02 centos6 v6.7 + Custom Repository
