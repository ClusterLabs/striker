...
wget http://10.20.4.2/centos6/x86_64/iso/$ISO -O /mnt/sysimage/var/www/html/centos6/x86_64/iso/$ISO
...
mount -o loop /mnt/sysimage/var/www/html/centos6/x86_64/iso/$ISO /mnt/source/
