...
mount -o loop /mnt/sysimage/var/www/html/rhel6/x86_64/iso/$ISO /mnt/img

echo "Copying 'Tools' into /mnt/sysimage/var/www/html/rhel6/x86_64/files/"
rsync -av /mnt/img/Tools /mnt/sysimage/var/www/html/rhel6/x86_64/files/
...
rsync -av /mnt/img/isolinux/* /mnt/sysimage/var/lib/tftpboot/boot/rhel6/x86_64/
%end
...
[striker02-rhel6]
name=Striker 02 RHEL 6.6 + Custom Repository
...
### The USB drives comes up as 'sdb'
