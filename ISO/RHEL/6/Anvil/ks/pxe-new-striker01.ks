...
network --device eth0 --bootproto dhcp --onboot yes --hostname new-striker01.alteeve.com
...
wget http://10.20.4.2/rhel6/x86_64/iso/Anvil_m2_RHEL-6.8_alpha.iso -O /mnt/sysimage/var/www/html/rhel6/x86_64/iso/Anvil_m2_RHEL-6.8_alpha.iso

# Make sure our source is mounted.
mount -o loop /mnt/sysimage/var/www/html/rhel6/x86_64/iso/Anvil_m2_RHEL-6.8_alpha.iso /mnt/source/
...
[striker01-rhel6]
name=Striker 01 rhel6 v6.8 + Custom Repository
